...
<form id="sync_form" action="javascript:simpan('sync_form','<?= $urlnya."/".encode($query["id_sales"]); ?>','','swal','3','1','1');" method="post" data-parsley-validate='true' enctype="multipart/form-data">
<div class="modal-body row">
  <div id="pesannya"></div>
  <?php
  $datanya[] = array('type'=>'hidden','name'=>'id_sales','icon'=>'-','html'=>'required style="text-transform: uppercase;"', 'value'=>$query['id_sales'], 'col'=> 12);

  $datanya[] = array('type'=>'text','name'=>'sales','nama'=>'Nama Sales','icon'=>'label','html'=>'required style="text-transform: uppercase;"', 'value'=>$query['sales'], 'col'=> 12);

  $datanya[] = array('type'=>'text','name'=>'no_hp','nama'=>ucwords('nohp'),'icon'=>'label','html'=>'required style="text-transform: uppercase;" onkeypress="return hanyaAngka(this)" maxlength="14"', 'value'=>$query['no_hp'], 'col'=> 12);
