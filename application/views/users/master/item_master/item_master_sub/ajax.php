      ...
      "columnDefs": [
        ...
        },
        {
          ...
          render: function(data, type, row) {
            ...
            <?php if (check_permission('view', 'update', "master/item_master_sub")) { ?>
              if (data.status==1) {
            ...
            <?php } ?>
            <?php if (check_permission('view', 'delete', "master/item_master_sub")) { ?>
              if (data.status==1) {
                hapus     = "btn_status('"+idnya+"', 0, 'Ubah Status Item ke Tidak Aktif')";
                ...
                hapus     = "btn_status('"+idnya+"', 1, 'Ubah Status Item ke Aktif')";
...
function btn_status(id='', stt='', msg='') {
  ...
  function(){
    // loading_show();
    hapus_data('master/simpan/item_master_sub_up_status/'+id, stt, '5', 1);
  });
}
</script>
