      ...
      "columnDefs": [
        ...
        },
        {
          ...
          render: function(data, type, row) {
            ...
            <?php if (check_permission('view', 'update', "master/pelanggan")) { ?>
              if (data.status==1) {
            ...
            <?php } ?>
            <?php if (check_permission('view', 'delete', "master/pelanggan")) { ?>
              if (data.status==1) {
...
function btn_status(id='', stt='', msg='') {
  ...
  function(){
    // loading_show();
    hapus_data('master/simpan/pelanggan_up_status/'+id, stt, '5', 1);
  });
}
</script>
