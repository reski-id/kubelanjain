...
<?php if (check_permission('view', 'create', 'master/item_lokasi')): ?>
<div class="col-12">
  <a href="javascript:aksi('tambah','','sync_form', '<?= $url_modal; ?>', 'lg');" class="btn btn-primary glow mb-1">+ <?php echo $judul_web; ?></a>
</div>
<?php endif; ?>
