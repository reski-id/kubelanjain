      ...
      "columnDefs": [
        ...
        },
        {
          ...
          render: function(data, type, row) {
            ...
            <?php if (check_permission('view', 'update', "master/item_lokasi")) { ?>
              if (data.status==1) {
            ...
            <?php } ?>
            <?php if (check_permission('view', 'delete', "master/item_lokasi")) { ?>
              if (data.status==1) {
...
function btn_status(id='', stt='', msg='') {
  ...
  function(){
    // loading_show();
    hapus_data('master/simpan/item_lokasi_up_status/'+id, stt, '5', 1);
  });
}
</script>
