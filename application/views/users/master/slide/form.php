...
<form id="sync_form" action="javascript:simpan('sync_form','<?= $urlnya."/".encode($query["id_slide"]); ?>','','swal','3','1','1');" method="post" data-parsley-validate='true' enctype="multipart/form-data">
<div class="modal-body">
  <div id="pesannya"></div>
  <?php

  $datanya[] = array('type'=>'text','name'=>'slide','nama'=>'Judul Slide','icon'=>'label','html'=>'required style="text-transform: uppercase;"', 'value'=>$query['slide'], 'col'=> 12);
  $datanya[] = array('type'=>'file','name'=>'foto_slide','nama'=>'Upload Foto Slide','icon'=>'image', 'html'=>'', 'col'=> 12);
