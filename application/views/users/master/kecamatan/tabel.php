<?php if (check_permission('view', 'create', 'master/kecamatan')) { ?>
<div class="row">
...
<div class="row">
  ...
  <div class="col-12 col-md-1"> <label>&nbsp;</label><button onclick="RefreshTable('', 1)" class="btn btn-primary">Submit</button> </div>
</div>
<br>
<?php get_pesan('msg'); ?>
            ...
            <table id="fileData" class="table table-bordered table-striped table-hover" width="100%">
              <thead>
                <tr>
                  <th width="1%">#</th>
                  <th>ID</th>
                  <th width="27%">Provinsi</th>
                  <th width="27%">Kota</th>
                  <th width="26%"><?php echo ucwords($tbl); ?></th>
                  <th width="19%">Opsi</th>
                </tr>
              </thead>
              <tbody></tbody>
