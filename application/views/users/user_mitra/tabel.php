...
<div hidden>
  <select class="form-control" id="id_mitrax" name="id_mitrax">
    <option value="1" <?php if(uri(3)==1){echo "selected";} ?>>Mitra 1</option>
    <option value="2" <?php if(uri(3)==2){echo "selected";} ?>>Mitra 2</option>
  </select>
</div>
    ...
    <div class="col-md-12">
      <div class="card widget-order-activity">
        <div class="card-header justify-content-between align-items-center">
            <h4 class="card-title">Filter <?php echo $judul_web; ?> <?= uri(3); ?></h4>
