<table class="table table-bordered table-hover table-striped" width="100%">
  <tbody>
    ...
    $not_view = array("id_$tbl", "password", "foto", "mode", "level", "status", "id_user_biodata", "id_mitra", "type_id", "id_user", "id_provinsi", "id_kota", "alamat_pengantaran", "informasi_dari", "id_referal"); ?>
