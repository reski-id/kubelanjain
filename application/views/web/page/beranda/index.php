...
<form id="sync_form" action="javascript:simpan('sync_form','pesan/simpan/pesan','','swal','3');" method="post" data-parsley-validate='true' enctype="multipart/form-data">
...
<!-- <form id="sync_form" method="post" data-parsley-validate='true' enctype="multipart/form-data"> -->
  ...
  <div class="form-group">
   ...
   <?php
   $datanya[] = array('type'=>'textarea','name'=>'pesan','nama'=>'Pesan','icon'=>'label','html'=>'required style="text-transform: uppercase;"', 'value'=>'');
  ...
  <!-- <button onclick="simpan()" class="btn btn-primary glow" name="simpan" id="simpan"> <span>SIMPAN</span> </button> -->
</form>
...
$( document ).ready(function() {
    $( "#nama" ).keypress(function(e) {
        var key = e.keyCode;
        // console.log(e.charCode); //keyCode keyboard
        //  A-Z                    || Space   || a-z
